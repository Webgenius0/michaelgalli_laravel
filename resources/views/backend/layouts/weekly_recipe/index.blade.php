@extends('backend.app', ['title' => 'Weekly Recipe Management'])
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Weekly Recipe Management</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Weekly Recipe Management</a></li>
                        ...
                        <div class="card product-sales-main">
                            <div class="card-header border-bottom">
                                ...
                                <div class="card-options ms-auto">
                                    <a href="{{ route('admin.weekly_recipe.create') }}" class="btn btn-primary btn-sm">Add</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="">
                                    <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-transparent border-bottom-0 wp-15">Price Per Servings </th>
                                                <th class="bg-transparent border-bottom-0 wp-15">Stripe Price ID</th>
