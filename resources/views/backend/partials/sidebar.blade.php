    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.meal_plan_option.*') ? 'active' : '' }}"
                        href="{{ route('admin.meal_plan_option.index') }}">
                ...
                <li class="slide {{ $isRecipeActive ? 'is-expanded' : '' }}">
                    <a class="side-menu__item {{ $isRecipeActive ? 'active' : '' }}" data-bs-toggle="slide"
                        href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 512 512"
                            fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="32">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.calories.index') }}"
                                class="slide-item {{ request()->routeIs('admin.calories.*') ? 'active' : '' }}">
                                Calories
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.carb.index') }}"
                                class="slide-item {{ request()->routeIs('admin.carb.*') ? 'active' : '' }}">
                                Carbs
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.cuisine.index') }}"
                                class="slide-item {{ request()->routeIs('admin.cuisine.*') ? 'active' : '' }}">
                                Cuisine type
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('admin.health_goal.index') }}"
                                class="slide-item {{ request()->routeIs('admin.health_goal.*') ? 'active' : '' }}">
                                Health Goal
                            </a>
                        </li>
