...
class HomeHowToWorkController extends Controller
{
    protected $cmsService;

    public $name = "home";
    public $section = "how_it_work";
    public $page = PageEnum::HOME;
    public $item = SectionEnum::HOME_HOW_IT_WORK;
    public $items = SectionEnum::HOME_HOW_IT_WORKS;
    public $count = 20;
