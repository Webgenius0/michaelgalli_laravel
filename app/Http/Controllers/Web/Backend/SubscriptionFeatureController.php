...
class SubscriptionFeatureController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $feature = SubscriptionFeature::latest()->first();

        return view("backend.layouts.feature.index", compact('feature'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.layouts.feature.create');
    }
    ...
    {
        $rules = [
            'id'              => 'nullable|exists:subscription_features,id',
            'description'     => 'required|string',
            'include_feature' => 'nullable|string',
        ];
        ...
        try {
            SubscriptionFeature::updateOrCreate(
                ['id' => $request->input('id')], // condition (if ID exists, update; else, create)
                [
                    'description'     => $request->input('description'),
                    'include_description' => $request->input('include_feature'),
                ]
            );

            return redirect()->route('admin.feature.index')->with('t-success', 'Feature saved successfully.');
        } catch (\Exception $e) {
    ...
    public function show($encryptedId)
    {
        ...
        return view('backend.layouts.feature.show', compact('recipe'));
    }
    ...
    public function edit($encryptedId)
    {
        ...
        return view('backend.layouts.feature.edit', compact(
            'meal_plan',
            'encryptedId'
        ));
    }
